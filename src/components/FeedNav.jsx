  ...
  return (
    <AppBar position="sticky">
      <StyledToolBar>
        ...
        <Typography
          variant="h1"
          sx={{ display: { xs: "none", sm: "block" }, fontSize: "24px" }}
        >
          <Link to={"/"} style={{ textDecoration: "none", color: "white" }}>
            Connect<span>ing</span>
          </Link>
        </Typography>
        <Typography
          variant="h1"
          sx={{ display: { xs: "block", sm: "none" }, fontSize: "24px" }}
        >
          <Link to={"/"} style={{ textDecoration: "none", color: "white" }}>
            <span>ing</span>
          </Link>
        ...
        <UserBox>
          <Tooltip title="Account settings">
            <>
              ...
              />{" "}
              <Typography variant="span"> {logger.name}</Typography>
            </>
          </Tooltip>
        </UserBox>
      </StyledToolBar>
      ...
      >
        ...
        <MenuItem>
          ...
          {muted.length === 0 ? (
            ...
            <AvatarGroup max={2}>
              {muted.map((val) => (
                <Avatar alt={val.fullName} key={val.id}>
                  {" "}
                  {val.name.charAt(0)}{" "}
                </Avatar>
              ))}
