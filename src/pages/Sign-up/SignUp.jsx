  ...
  const signin = () => {
    ...
    if (email === "" || password === "" || uname === "" || name === "") {
      document.querySelector("#warning").innerHTML =
        "Please fill in all details to sign up.";
      ...
      <div id="signContainer">
        ...
        <div id="signFormContainer">
          ...
          <div style={{ width: "80%", margin: "auto", marginTop: "2vh" }}>
            ...
            <p style={{ fontSize: "2vh", margin: "1vh 2.5vh", color: "grey" }}>
              By clicking Agree & Join, you agree to the Connecting User
